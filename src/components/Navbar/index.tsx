            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex justify-center px-2 gap-8">
                    ...
                    >
                        ...
                        <span
                            aria-hidden="true"
                            className={`h-1 w-12 bg-current transform transition duration-500 ease-in-out rounded ${menuOpen ? "translate-y-[12px] rotate-45" : " -translate-y-2"}`}
                        ></span>
                        <span
                            aria-hidden="true"
                            className={`h-1 w-12 bg-current transform transition duration-500 ease-in-out rounded ${menuOpen ? "opacity-0" : ""}`}
                        ></span>
                        <span
                            aria-hidden="true"
                            className={`h-1 w-12 bg-current transform transition duration-500 ease-in-out rounded ${menuOpen ? " -translate-y-[12px] -rotate-45" : " translate-y-2"}`}
