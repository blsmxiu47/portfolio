    ...
    return (
        <div className="mx-2 my-32">
            <div className="flex flex-col text-center">
                ...
                <h2 className="text-[1.5rem] mb-1">My name is <strong className="text-[1.75rem] bg-clip-text text-transparent bg-gradient-to-r from-[#3F0071] to-[#FB2576]">Wes (he/they)</strong>.</h2>
