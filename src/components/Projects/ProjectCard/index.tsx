...
const ProjectCard = ({
    ...
    return (
        <a
            className="relative group h-80 max-w-[16rem] justify-self-center flex flex-col justify-top mx-2 my-1 rounded-lg shadow-md hover:scale-110 transition duration-700 ease-in-out cursor:pointer bg-gray-100 dark:bg-gray-800"
            href={githubLink}
            target="_blank"
